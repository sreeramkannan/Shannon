...
f_log.write(str(time.asctime()) + ": " +"Number of Remaining Partitions: " + str(num_remaining)  + "\n")
f_log.write(str(time.asctime()) + ": " +"Number of Non-Remaining Partitions: " + str(num_non_remaining)  + "\n")

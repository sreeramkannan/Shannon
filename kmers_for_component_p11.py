...
#directory = "S15_SE_contig_partition"
#directory_name = "NM_metis_test"
#kmer_directory = "WW_NM_181697_algo_input" # K = 25
#kmer_directory = "./S15_SE_algo_input" # K = 24
#directory_name = "./S15_SE_contig_partition2"
...
def kmers_for_component(kmer_directory, reads_files, directory_name, contig_file_extension, new_kmer_tag, graph_file_extension, get_og_comp_kmers, get_partition_kmers, double_stranded, paired_end = False, second_iteration = False,  partition_size = 500, overload = 1.5, K = 24):
    ...
    if get_partition_kmers:
        ...
        f_log.write(str(time.asctime()) + ": " + "gpmetis for partitioning " + str(int(second_iteration)+1) + " is complete" + "\n")
        ...
        # kmer streaming for outputting kmers
            ...
            with open(directory_name+"/component" + comp +  new_kmer_tag + "kmers_allowed.dict" , 'w') as new_file:
                for contig in new_components[comp]:
                    for i in range(len(contig)-(K) + 1):
                        kmer = contig[i:i+(K)]
                        #if kmer in seen_before:
                        #    pdb.set_trace()
                        #seen_before[kmer] = contig
...
'''kmer_directory = "./S15_SE_algo_input" # K = 24
base_directory_name = "./S15_SE_contig_partition"
...
new_directory_name = "S15"

new_components = kmers_for_component(kmer_directory, base_directory_name, r1_contig_file_extension, r1_new_kmer_tag, r1_graph_file_extension, get_og_comp_kmers, get_partition_kmers, Partitions, ufactor, K)
'''
...
if run_parallel:
    run_cmd("parallel python main_server_WWY_p11.py {} --run_alg " + ds_string + " --kmer_size " + str(K)  + " " + paired_end_flag + " ::: " + main_server_parameter_string)
else:
    for param_str in main_server_parameter_string.split():
	run_cmd("python main_server_WWY_p11.py " + param_str + " --run_alg " + ds_string + " --kmer_size " + str(K)  + " " + paired_end_flag + " " + param_str)
